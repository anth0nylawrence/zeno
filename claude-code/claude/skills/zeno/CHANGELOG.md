...
## 0.2.0
- Ported to Claude Code hooks (SessionStart/UserPromptSubmit/Stop/PreCompact/PostToolUse)
- Added hook utilities and context injection bridge
- Added Claude Code settings example and hooks config
- Updated docs for hook-based persistence and OTEL env variables

## 0.1.1
- Added notify checkpoint log (`.claude/zeno/notify.log`) for CLI tailing
